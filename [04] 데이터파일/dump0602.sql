...
CREATE TABLE `address` (
  ...
  UNIQUE KEY `address_UNIQUE` (`roadAddress`)
...
) ENGINE=InnoDB AUTO_INCREMENT=42319 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT ` contract` FOREIGN KEY (`contract`) REFERENCES `contract` (`contract_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `user` (`num`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-06-02 18:11:33
