...
) ENGINE=InnoDB AUTO_INCREMENT=94369 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contract` (
  ...
  `monthly` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  ...
  `created_at` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `is_expired` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=162844 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT `around_around_id2` FOREIGN KEY (`around_around_id`) REFERENCES `around` (`around_id`) ON DELETE CASCADE,
  CONSTRAINT `user_num` FOREIGN KEY (`user_num`) REFERENCES `user` (`num`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=540256 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `status` (
  ...
  KEY `around_idx` (`around_around_id`),
  CONSTRAINT `around_around_id1` FOREIGN KEY (`around_around_id`) REFERENCES `around` (`around_id`) ON DELETE CASCADE
...
-- Dump completed on 2020-06-23 18:37:33
