...
CREATE TABLE `favorite` (
  ...
  `around` bigint NOT NULL,
  `user` bigint NOT NULL,
  `score` int NOT NULL,
  PRIMARY KEY (`favorite_id`),
  KEY `around_idx` (`around`),
  KEY `user_idx` (`user`),
  CONSTRAINT `around` FOREIGN KEY (`around`) REFERENCES `around` (`around_id`) ON DELETE CASCADE,
  CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `user` (`num`) ON DELETE CASCADE
...
-- Dump completed on 2020-06-03 19:13:12
